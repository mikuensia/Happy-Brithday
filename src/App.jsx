...
import heroImg from "./assets/pics/utama.jpg";
    ...
    <main>
      ...
      >
        ...
        <div className="w-full max-w-screen-2xl px-5 lg:px-10 mb-[5%] flex flex-col gap-3 lg:gap-5 z-10 text-white ">
          ...
          >
            How to say Happy Birthday before I make a mistake.
          </h1>
          <p
          ...
          >
            This is how Broo, someone you may have known, expressed his admiration. From a distance, he watched your light grow brighter, hoping that one day you would notice. But for now, this is how Broo wished you a happy birthday.
          </p>
      ...
      <Modal setOpenModal={setOpenModal} openModal={openModal}>
        ...
        <div className="flex flex-col gap-3 lg:gap-5 p-5 text-white">
          <h1 className="font-bold text-2xl">Big bday shoutout to the real MVP! </h1>
          <p>YO BROO </p>
          <p>
          Happy 17th, bro! Sweet 17, the year where everything starts to get real. But no stress—it’s also the year for fun, laughter, and crazy adventures. Wishing you nothing but good vibes, epic memories, and success in everything you do. You’re stepping into the age where the world begins to open up, so take it one step at a time and enjoy the ride. We’re proud of you, bro—keep being the legend you’ve always been. 


          </p>
          Let’s make today and this year a celebration of YOU. Cheers to 17!
          <p>
          last I want to say HAPPY BRITHDAY BROO🎂
          btw jangan lupa traktirannya 
